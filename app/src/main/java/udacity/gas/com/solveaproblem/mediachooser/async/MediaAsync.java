package udacity.gas.com.solveaproblem.mediachooser.async;
 ...
 *
 * <p>ImageChooserAsync is designed to be a helper class around {@link Thread} and {@link android.os.Handler}
...
public abstract class MediaAsync<Params, Progress, Result> {
	 ...
	 */
	  ...
	  *         {@link udacity.gas.com.solveaproblem.mediachooser.async.MediaAsync.Status#RUNNING} or {@link udacity.gas.com.solveaproblem.mediachooser.async.MediaAsync.Status#FINISHED}.
	  *
	  ...
	  * ImageChooserAsync, however you can also use your own {@link java.util.concurrent.Executor} for custom
	  * behavior.
	  * 
